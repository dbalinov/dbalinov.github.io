  ...
  return <footer className="p-4 bg-white sm:p-6 mt-8">
    ...
    <div className='container mx-auto'>
      <div className="sm:flex sm:items-center sm:justify-between">
        <a href="/" className="flex items-center mb-4 sm:mb-0">
          <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3" alt="Data for Good - Bulgaria Logo" />
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
      <span className="text-sm text-gray-500 sm:text-center">
        © 2023 <a href="https://flowbite.com/" className="hover:underline">Data for Good - Bulgaria</a>. All Rights Reserved.
      </span>
